<template>
  <view class="index-page flex flex-col">
    <!-- 活动banner列表 -->
    <swiper :autoplay="true" :duration="1000" :indicator-dots="true" :interval="3500" class="banner-swiper"
    ...
    <view class="quick-entry box-border">
      <view v-for="(item, index) in entryList" :key="index" class="entry-item">
    ...
    <view class="recent-activities">
      <view v-for="(item, index) in activityList" :key="index" class="activity-item"
            @click="navigateToPromotionInfo(item.id)">
        <image :src="item.imageUrl" mode="aspectFit"></image>
...
const activityList = ref([
  {imageUrl: '/static/activity1.jpg', id: 1, title: '活动1', date: '2023-04-15'},
  {imageUrl: '/static/activity2.jpg', id: 2, title: '活动2', date: '2023-04-20'},
  {imageUrl: '/static/activity3.jpg', id: 3, title: '活动3', date: '2023-04-25'},
])
...
const navigateToPromotionInfo = (id) => {
  if (id) {
    uni.navigateTo({
      url: `/pages/event-info/index?id=${id}`,
    })
  }
}
